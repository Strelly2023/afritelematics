...
export const NOVACODEPRO_FRONTEND_MANIFEST = createProductFrontendManifest({
  ...
  navigationItems: [
    ...
    {
      id: "novacodepro-product-factory",
      label: "Product Factory",
      path: ROUTES.productFactoryRoot,
  ...
  routes: [
    ...
    {
      routeId: "novacodepro.product-factory",
      productCode: "novacodepro",
      path: ROUTES.productFactoryRoot,
      title: "Product Factory",
      audience: "EMPLOYEE",
      layout: "shared",
      featureFlag: "novacodepro.product-factory.enabled",
      requiredPermissions: ["workspace.read"],
    },
  ],
  requiredPermissions: ["novacodepro:workspace:view", "novacodepro:solutions:view", "workspace.read"],
  featureFlags: ["novacodepro.enabled", "novacodepro.solution-engineering.enabled", "novacodepro.product-factory.enabled"],

...
flowchart LR
    ...
    subgraph FastAPI["Startup-Safe FastAPI Surface (741 modules)"]
    ...
    App -. startup imports .-> Imports["Direct startup imports from app.py (99)"]
```

...
This release advances the NovaRide public-pilot line with a stricter device-attestation policy for Rider and Driver. It does not enable General Availability, unrestricted public registration, real payments, or autonomous authority.

## Key Changes

- Dedicated static download routing for `download.afritechnology.com`.
- Immutable APK release paths under `/novaride/releases/2026.1.3/`.
- Public-pilot Rider and Driver metadata set to `2026.1.3`.
- Explicit public-pilot attestation fallback when policy permits.
...
- `https://download.afritechnology.com/novaride/releases/2026.1.3/novaride-rider-v2026.1.3-public-pilot.ipa`
- `https://download.afritechnology.com/novaride/releases/2026.1.3/novaride-driver-v2026.1.3-public-pilot.ipa`

...
def test_rider_runtime_mode_and_http_client_are_explicit() -> None:
    ...
    assert "cursor" in realtime
    assert "reconnectAttempt" in realtime


def test_rider_package_test_gate_runs_full_tree() -> None:

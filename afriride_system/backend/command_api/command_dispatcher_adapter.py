...
class AfriRideCommandDispatcher:
    ...
    drivers: dict[str, DriverSession] = field(default_factory=dict)
    rides: dict[str, RideSession] = field(default_factory=dict)

    def set_driver_status(self, driver_id: str, online: bool) -> dict[str, Any]:
        session = DriverSession(driver_id=driver_id, online=online)
        self.drivers[driver_id] = session
    ...
    def request_ride(
        ...
        *,
        ...
        self.rides[resolved_ride_id] = ride

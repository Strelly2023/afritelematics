...
def test_operator_dashboard_exposes_novacodepro_developer_platform_phase() -> None:
    ...
    for required in (
        ...
        "https://novacodepro.afritechnology.com",
        "docs.novacodepro.afritechnology.com",
        "academy.novacodepro.afritechnology.com",
        "Overview",
        "Projects",
        "Repositories",
        "UX Studio",
    ...
    for required in (
        ...
        "activeDocsCategory",
        "workspaceFlowStep",
        "NOVACODEPRO_PORTAL_URL",
        "NOVACODEPRO_PORTAL_NAV",
        "NOVACODEPRO_PORTAL_SUBDOMAINS",
...
def test_operator_dashboard_exposes_novacodepro_engineering_operating_system_experience() -> None:
    source = read("src/App.jsx")
    styles = read("src/styles.css")

    for required in (
        "NovaCodePro Engineering Operating System Experience",
        "Engineering Operating System Command Center",
        "Full-screen mission control dashboard",
        "production maturity",
        "implemented services, APIs, operational controls, runtime infrastructure, and production validation",
        ...
        "Policies",
        "AI Agents",
        "AI Engineering Operating Center",
        "Nova Architect",
        "Nova Developer",
        "Nova Reviewer",
        "Nova Security",
        ...
        "Nova Auditor",
        "Nova SRE",
        "Nova Release Manager",
        "Start Engineering Mission",
        "Engineering Mission Verified",
        "Evidence Generated",
        ...
        "Audit Packet",
        "Replay Packet",
        "Unified Engineering Timeline",
        "Architecture, repositories, commits, PRs, reviews, pipelines, deployments, incidents, recoveries, evidence, and replay",
        "Global Engineering Infrastructure",
        "Australia",
        "Singapore",
        "Japan",
        "India",
        ...
        "Global to evidence infrastructure hierarchy",
        ...
        "Expand Region",
        "Live Trust Center",
        "Overall Engineering Trust Score",
        "Architecture Decision Center",
        "Interactive ADR explorer",
        "Multi-Tenant Engineering OS",
    ...
    for required in (
        ...
        "selectedDigitalTwin",
        "selectedEosAiAgent",
        "engineeringMissionActive",
        "engineeringMissionStep",
        "selectedTimelineFilter",
        "selectedEvidencePacket",
        "selectedInfrastructureView",
        "selectedEngineeringTrustMetric",
        "selectedEngineeringGraphNode",
    ):
        assert required in source

    for required in (
        ".codepro-eos-platform",
        ".eos-command-shell",
        ".eos-command-metric-grid",
        ".eos-twin-grid",
        ".eos-graph-grid",
        ".eos-ai-grid",
        ".eos-mission-step-grid",
        ".eos-evidence-grid",
        ".eos-region-grid",
        ".eos-ops-grid",
        ".eos-observability-grid",
        ".eos-control-plane-grid",
        ".eos-mission-card-grid",
        ".eos-trust-grid",
        ".eos-marketplace-grid",
        ".eos-kpi-grid",
    ):
        assert required in styles


def test_operator_dashboard_exposes_novacodepro_next_generation_service_platform() -> None:
    source = read("src/App.jsx")
    styles = read("src/styles.css")

    for required in (
        "NovaCodePro Next Generation Platform",
        "Unified Engineering and Service Delivery Platform",
        "system of work",
        "Design. Build. Secure. Deploy. Operate. Govern. Improve.",
        "Customers & Partners",
        ...
        "AI Domain",
        "Marketplace Domain",
        "shared services, not separate business silos",
        ...
        "Service Mesh",
        "Observability Stack",
        "NovaCodePro Services",
        "Design. Build. Deploy. Operate. Transform.",
        "technology, engineering, AI, cloud, and managed digital services",
        ...
        "Staff augmentation",
        "How This Fits Into NovaTech",
        "NovaCodePro Professional Services",
        "focused on technology services, not unrelated business domains",
    ):
        assert required in source

    for required in (
        ".codepro-nextgen-platform",
        ".codepro-nextgen-mission",
        ".nextgen-reference-stack",
        ".nextgen-platform-section",
        ".nextgen-access-grid",
        ".nextgen-domain-grid",
        ".nextgen-service-grid",
        ".nextgen-mode-grid",
        ".nextgen-user-grid",
        ".nextgen-flow-grid",
        ".nextgen-foundation-grid",
        ".nextgen-service-catalog-grid",
        ".nextgen-delivery-grid",
        ".nextgen-delivery-flow",
        ".nextgen-engagement-grid",
        ".nextgen-fit-stack",
    ):
        assert required in styles

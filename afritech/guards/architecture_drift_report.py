...
TRACKED_MODULES = {
    "afriride_system/api/architecture_routes.py",
    "afriride_system/api/auth.py",
    "afriride_system/api/controlled_pilot_routes.py",
    "afriride_system/api/corridors_routes.py",
    "afriride_system/api/global_routes.py",
    ...
    "afriride_system/api/internal_qa_contract_routes.py",
    "afriride_system/api/logging.py",
    "afriride_system/api/main.py",
    "afriride_system/api/operations_routes.py",
    "afriride_system/api/payment_routes.py",
    "afriride_system/api/public_pilot_routes.py",
    ...
    "afriride_system/api/security.py",
    "afriride_system/api/trace_middleware.py",
    "afriride_system/api/treasury_routes.py",
    ...
    "afritech/api/afriride_mobile_release_api.py",
    "afritech/api/afriride_operational_api.py",
    "afritech/api/api_catalog_api.py",
    "afritech/api/api_platform_admin_api.py",
    "afritech/api/core_platform_api.py",
    "afritech/api/data_governance_api.py",
    "afritech/api/delivery_platform_api.py",
    "afritech/api/afriprogramming_control_api.py",
    "afritech/api/afriprogramming_views.py",
    "afritech/api/afroprog_workspace_api.py",
    "afritech/api/documentation_compliance_api.py",
    ...
    "afritech/api/mobile_intelligence_api.py",
    "afritech/api/explain_execution_views.py",
    "afritech/api/executable_runtime_api.py",
    "afritech/api/integration_platform_api.py",
    "afritech/api/novaid_api.py",
    "afritech/api/feature_registry_api.py",
    "afritech/api/governance_impact_views.py",
    "afritech/api/novapay_ecosystem_api.py",
    "afritech/api/novapay_runtime_api.py",
    "afritech/api/novacodepro_operational_verification_api.py",
    "afritech/api/novacodepro_platform_api.py",
    "afritech/api/novacodepro_ncp003_api.py",
    "afritech/api/novacodepro_ncp004_api.py",
    "afritech/api/novacodepro_ncp005_api.py",
    "afritech/api/novacodepro_ncp006a_api.py",
    "afritech/api/novacodepro_ncp006b_api.py",
    "afritech/api/novacodepro_ncp007_api.py",
    "afritech/api/novacodepro_ncp008_api.py",
    "afritech/api/novacodepro_product_factory_api.py",
    "afritech/api/novaid_audit_replay_api.py",
    "afritech/api/novaride_operations_api.py",
    ...
    "afritech/api/partner_certification_api.py",
    "afritech/api/partner_governance_api.py",
    "afritech/api/phase0_api.py",
    "afritech/api/phase1_api.py",
    "afritech/api/phase2_api.py",
    "afritech/api/phase3_api.py",
    "afritech/api/phase4_api.py",
    "afritech/api/phase5_api.py",
    "afritech/api/phase6_api.py",
    "afritech/api/phase7_api.py",
    "afritech/api/phase8_api.py",
    "afritech/api/phase9_api.py",
    "afritech/api/phase10_api.py",
    "afritech/api/phase11_api.py",
    "afritech/api/phase12_api.py",
    ...
    "afritech/api/platform_runtime_api.py",
    "afritech/api/public_verification_api.py",
    "afritech/api/public_gateway_api.py",
    "afritech/api/runtime_activation_api.py",
    "afritech/api/runtime_infrastructure_api.py",
    "afritech/api/runtime_operations_api.py",
    "afritech/api/runtime_verification_api.py",
    "afritech/api/runtime_worker_api.py",
    "afritech/api/semantic_admission.py",
    "afritech/api/solution_engineering_api.py",
    ...
    "afriride_system/api/runtime_security.py",
    ...
    "dashboard/src/LiveVerifierPanel.jsx",
    "dashboard/src/TrustExplorer.jsx",
    "dashboard/src/main.jsx",
    "dashboard/src/styles.css",
    "dashboard/src/realtime.js",
}

...
SUBSYSTEMS: tuple[ValidationSubsystem, ...] = (
    ...
    ValidationSubsystem(name="driver_api_contract_receipt_validator", module="afritech.ci.driver_api_contract_receipt_validator", phase=5),
    ValidationSubsystem(name="driver_event_contract_binding_validator", module="afritech.ci.driver_event_contract_binding_validator", phase=5),
    ValidationSubsystem(name="driver_contract_replay_validator", module="afritech.ci.driver_contract_replay_validator", phase=5),
    ValidationSubsystem(name="afriprogramming_cli_surface_validator", module="afritech.ci.afriprogramming_cli_surface_validator", phase=5),
    ValidationSubsystem(name="afriprog_copilot_assist_validator", module="afritech.ci.afriprog_copilot_assist_validator", phase=5),
    ValidationSubsystem(name="afriprog_ai_suggestion_non_authority_validator", module="afritech.ci.afriprog_ai_suggestion_non_authority_validator", phase=5),
    ValidationSubsystem(name="afriprog_inline_fix_validation_gate", module="afritech.ci.afriprog_inline_fix_validation_gate", phase=5),
    ValidationSubsystem(name="afriprog_context_proposal_validator", module="afritech.ci.afriprog_context_proposal_validator", phase=5),
    ValidationSubsystem(name="afriprog_auto_validation_loop_validator", module="afritech.ci.afriprog_auto_validation_loop_validator", phase=5),
    ValidationSubsystem(name="afriprog_tooling_proposal_non_authority_validator", module="afritech.ci.afriprog_tooling_proposal_non_authority_validator", phase=5),
    ValidationSubsystem(name="afriprog_governance_readiness_validator", module="afritech.ci.afriprog_governance_readiness_validator", phase=5),
    ValidationSubsystem(name="afriprog_activation_boundary_validator", module="afritech.ci.afriprog_activation_boundary_validator", phase=5),
    ValidationSubsystem(name="afriprog_runtime_monitoring_validator", module="afritech.ci.afriprog_runtime_monitoring_validator", phase=5),
    ValidationSubsystem(name="afriprog_anomaly_detection_validator", module="afritech.ci.afriprog_anomaly_detection_validator", phase=5),
    ValidationSubsystem(name="afriprog_anomaly_proposal_conversion_validator", module="afritech.ci.afriprog_anomaly_proposal_conversion_validator", phase=5),
    ValidationSubsystem(name="afriprog_runtime_non_authority_validator", module="afritech.ci.afriprog_runtime_non_authority_validator", phase=5),
    ValidationSubsystem(name="afriprog_anomaly_context_integrity_validator", module="afritech.ci.afriprog_anomaly_context_integrity_validator", phase=5),
    ValidationSubsystem(name="afriprog_drift_detection_validator", module="afritech.ci.afriprog_drift_detection_validator", phase=5),
    ValidationSubsystem(name="afriprog_contract_monitoring_validator", module="afritech.ci.afriprog_contract_monitoring_validator", phase=5),
    ValidationSubsystem(name="afriprog_drift_proposal_validator", module="afritech.ci.afriprog_drift_proposal_validator", phase=5),
    ValidationSubsystem(name="afriprog_agent_non_authority_validator", module="afritech.ci.afriprog_agent_non_authority_validator", phase=5),
    ValidationSubsystem(name="afriprog_runtime_observation_integrity_validator", module="afritech.ci.afriprog_runtime_observation_integrity_validator", phase=5),
    ValidationSubsystem(name="afriprog_investor_demo_truth_boundary_validator", module="afritech.ci.afriprog_investor_demo_truth_boundary_validator", phase=5),
    ValidationSubsystem(name="afriprog_global_anomaly_consensus_validator", module="afritech.ci.afriprog_global_anomaly_consensus_validator", phase=5),
    ValidationSubsystem(name="afriprog_evidence_integrity_validator", module="afritech.ci.afriprog_evidence_integrity_validator", phase=5),
    ValidationSubsystem(name="afriprog_consensus_threshold_validator", module="afritech.ci.afriprog_consensus_threshold_validator", phase=5),
    ValidationSubsystem(name="afriprog_consensus_non_authority_validator", module="afritech.ci.afriprog_consensus_non_authority_validator", phase=5),
    ValidationSubsystem(name="afriprog_cross_node_context_validator", module="afritech.ci.afriprog_cross_node_context_validator", phase=5),
    ValidationSubsystem(name="afriprog_federation_protocol_validator", module="afritech.ci.afriprog_federation_protocol_validator", phase=5),
    ValidationSubsystem(name="afriprog_cross_network_signature_validator", module="afritech.ci.afriprog_cross_network_signature_validator", phase=5),
    ValidationSubsystem(name="afriprog_constitutional_compliance_validator", module="afritech.ci.afriprog_constitutional_compliance_validator", phase=5),
    ValidationSubsystem(name="afriprog_federated_vote_validator", module="afritech.ci.afriprog_federated_vote_validator", phase=5),
    ValidationSubsystem(name="afriprog_sovereignty_enforcement_validator", module="afritech.ci.afriprog_sovereignty_enforcement_validator", phase=5),
    ValidationSubsystem(name="afriprog_uml_structure_validator", module="afritech.ci.afriprog_uml_structure_validator", phase=5),
    ValidationSubsystem(name="afriprog_uml_to_proposal_validator", module="afritech.ci.afriprog_uml_to_proposal_validator", phase=5),
    ValidationSubsystem(name="afriprog_uml_non_authority_validator", module="afritech.ci.afriprog_uml_non_authority_validator", phase=5),
    ValidationSubsystem(name="afriprog_uml_consistency_validator", module="afritech.ci.afriprog_uml_consistency_validator", phase=5),
    ValidationSubsystem(name="afriprog_srp_validator", module="afritech.ci.afriprog_srp_validator", phase=5),
    ValidationSubsystem(name="afriprog_ocp_validator", module="afritech.ci.afriprog_ocp_validator", phase=5),
    ValidationSubsystem(name="afriprog_lsp_validator", module="afritech.ci.afriprog_lsp_validator", phase=5),
    ValidationSubsystem(name="afriprog_isp_validator", module="afritech.ci.afriprog_isp_validator", phase=5),
    ValidationSubsystem(name="afriprog_dip_validator", module="afritech.ci.afriprog_dip_validator", phase=5),
    ValidationSubsystem(name="afriprog_design_invariant_validator", module="afritech.ci.afriprog_design_invariant_validator", phase=5),
    ValidationSubsystem(name="ai_constraint_engine_validator", module="afritech.ci.ai_constraint_engine_validator", phase=5),
    ValidationSubsystem(name="multi_agent_non_authority_validator", module="afritech.ci.multi_agent_non_authority_validator", phase=5),
    ValidationSubsystem(name="llm_boundary_validator", module="afritech.ci.llm_boundary_validator", phase=5),
    ValidationSubsystem(name="vscode_extension_surface_validator", module="afritech.ci.vscode_extension_surface_validator", phase=5),
    ValidationSubsystem(name="replay_graph_viewer_validator", module="afritech.ci.replay_graph_viewer_validator", phase=5),
    ValidationSubsystem(name="timeline_playback_viewer_validator", module="afritech.ci.timeline_playback_viewer_validator", phase=5),
    ValidationSubsystem(name="tooling_proposal_emission_validator", module="afritech.ci.tooling_proposal_emission_validator", phase=5),
    ValidationSubsystem(name="governance_approval_flow_validator", module="afritech.ci.governance_approval_flow_validator", phase=5),
    ValidationSubsystem(name="tooling_activation_gate_validator", module="afritech.ci.tooling_activation_gate_validator", phase=5),
    ValidationSubsystem(name="proposal_replay_record_validator", module="afritech.ci.proposal_replay_record_validator", phase=5),
    ValidationSubsystem(name="proposal_rollback_readiness_validator", module="afritech.ci.proposal_rollback_readiness_validator", phase=5),
    ValidationSubsystem(name="proposal_lifecycle_completion_validator", module="afritech.ci.proposal_lifecycle_completion_validator", phase=5),

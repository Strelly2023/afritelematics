...
"""
    ...
    def __init__(self, redis_client: Any, *, required: bool = False, metrics=None) -> None:
        ...
        self._scripts = {
            "created": self._register_script(self.CREATE_SCRIPT),
            "consumed": self._register_script(self.CONSUME_SCRIPT),
            "superseded": self._register_script(self.TOGGLE_SCRIPT),
            "expired": self._register_script(self.TOGGLE_SCRIPT),
            "cancelled": self._register_script(self.TOGGLE_SCRIPT),
        }

...
def _novaride_ecosystem_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "architecture_version": architecture_contract["architecture_version"],
        "enterprise_operations_layer": architecture_contract["enterprise_operations_layer"],
        ...
        "layered_architecture": architecture_contract["layered_architecture"],
        "operator_intervention_flow": architecture_contract["operator_intervention_flow"],
        "maturity_dimensions": architecture_contract["maturity_dimensions"],
        "production_infrastructure_readiness": architecture_contract["production_infrastructure_readiness"],

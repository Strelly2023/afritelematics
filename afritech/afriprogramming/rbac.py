...
LEGACY_ROLE_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "SENIOR_DEVELOPER": {
        ...
        "category": "core",
        "mission": "Deliver high-complexity software changes and mentor engineering teams.",
        "aliases": ("SENIOR DEV", "STAFF ENGINEER"),
        "permissions": (
            "development.workspace.read",
            "development.workspace.configure",
            "repository.read",
        ...
        "visible_panels": ("Development Studio", "Repository", "Diff", "Validation", "Review", "Evidence"),
        "api_surfaces": (
            "/api/v1/development/workspaces",
            "/api/v1/development/sessions",
            "/api/v1/development/change-sets",
        ),
        "dashboard_surface": "/v1/novaprogramming/staff/senior-developer/dashboard",
    },
    "TECH_LEAD": {
        "label": "Tech Lead",
        "category": "core",
        "mission": "Guide implementation quality, approvals, repository change control, and release readiness.",
        ...
        "visible_panels": ("Development Studio", "Repository", "Validation", "Approvals", "Release Candidate"),
        "api_surfaces": (
            "/api/v1/development/workspaces",
            "/api/v1/development/change-sets",
            "/api/v1/development/approvals",
        ),
        "dashboard_surface": "/v1/novaprogramming/staff/tech-lead/dashboard",
    },
    "PROJECT_OWNER": {
        "label": "Project Owner",
        "category": "core",
        "mission": "Own project scope, governed delivery, and approval routing for software changes.",
        ...
        "visible_panels": ("Development Studio", "Tasks", "Approvals", "Release Readiness"),
        "api_surfaces": ("/api/v1/development/workspaces", "/api/v1/development/sessions"),
        "dashboard_surface": "/v1/novaprogramming/staff/project-owner/dashboard",
    },
    "APPROVER": {
        "label": "Approver",
        "category": "core",
        "mission": "Review governed changes and sign off on risk-controlled repository updates.",
        "aliases": (),
        "permissions": (
            "development.workspace.read",
            "repository.read",
        ...
        "visible_panels": ("Approvals", "Evidence", "Change Sets"),
        "api_surfaces": ("/api/v1/development/approvals",),
        "dashboard_surface": "/v1/novaprogramming/staff/approver/dashboard",
    },
    "RELEASE_MANAGER": {
        "label": "Release Manager",
        "category": "core",
        "mission": "Prepare release candidates and govern promotion of approved code changes.",
        "aliases": ("RELEASE", "RELEASE LEAD"),
        "permissions": (
            "development.workspace.read",
            "repository.read",
            "repository.commit.prepare",
        ...
        "visible_panels": ("Development Studio", "Release Candidate", "Approvals", "Evidence"),
        "api_surfaces": ("/api/v1/development/change-sets", "/api/v1/development/commit-proposals"),
        "dashboard_surface": "/v1/novaprogramming/staff/release-manager/dashboard",
    },
    "READ_ONLY_REVIEWER": {
        "label": "Read Only Reviewer",
        "category": "core",
        "mission": "Inspect governed development work without mutation authority.",
        "aliases": ("REVIEWER",),
        "permissions": (
            "development.workspace.read",
            "repository.read",
        ...
        "visible_panels": ("Development Studio", "Repository", "Evidence"),
        "api_surfaces": ("/api/v1/development/workspaces", "/api/v1/development/change-sets"),
        "dashboard_surface": "/v1/novaprogramming/staff/reviewer/dashboard",
    },
    "AI_AGENT": {
        "label": "AI Agent",
        "category": "core",
        "mission": "Propose governed code changes within approved scopes.",
        "aliases": (),
        "permissions": (
            "development.workspace.read",
            "repository.read",
        ...
        "visible_panels": ("Development Studio", "Proposals", "Evidence"),
        "api_surfaces": ("/api/v1/development/tasks", "/api/v1/development/generation-requests"),
        "dashboard_surface": "/v1/novaprogramming/staff/ai-agent/dashboard",
    },
    "SERVICE_ACCOUNT": {
        "label": "Service Account",
        "category": "core",
        "mission": "Execute limited, pre-authorized automation tasks on behalf of governance flows.",
        "aliases": (),
        "permissions": (
            "development.workspace.read",
            "repository.read",
        ...
        "visible_panels": ("Automation", "Validation"),
        "api_surfaces": ("/api/v1/development/sessions",),
        "dashboard_surface": "/v1/novaprogramming/staff/service-account/dashboard",
    },
    "OBSERVER": {
        "label": "Observer",
        "category": "legacy",

...
def build_eros_manifest() -> dict[str, Any]:
    return {
        ...
        "vision": "Anticipate, withstand, respond to, recover from, and continuously learn from disruptions across people, processes, technology, products, data, partners, and AI systems.",
        "architecture": [
            "Observation Engine",
        ...
        "autonomy_levels": [
            {"level": 0, "mode": "Observe Only"},
            {"level": 1, "mode": "Recommend"},
            {"level": 2, "mode": "Execute After Approval"},
            {"level": 3, "mode": "Policy-Governed Autonomous Execution"},
        ],
        "twin_hierarchy": [
            "Enterprise Twin",
            "Organization Twins",
        ...
        "apis": [
            "GET /v1/eros/status",
            "GET /v1/eros/resilience",
            "GET /v1/eros/incidents",
            "GET /v1/eros/recovery-plans",
            "POST /v1/eros/simulate",
            "POST /v1/eros/predict",
            "POST /v1/eros/recover",
            "POST /v1/eros/validate",
            "POST /v1/eros/learn",
        ],
        "events": [
            "eros.incident.detected",
            "eros.simulation.completed",
            "eros.recovery.started",
            "eros.recovery.completed",
            "eros.validation.passed",
            "eros.validation.failed",
            "eros.lessons.recorded",
            "eros.resilience.updated",
        ],
        "dashboards": [
            ...
            "Prediction Center",
            "Risk Center",
            "Recovery Validation Center",
            "Lessons Learned Center",
            "Executive Dashboard",
        ],
        "maturity_model": ["Reactive", "Documented", "Managed", "Integrated", "Intelligent", "Adaptive Autonomous"],
        "notes": [
            ...
            "Optimize closes the resilience loop by feeding lessons into architecture, policy, and operations.",
        ],
    }

...
DEFAULT_DEPLOYMENT_PROFILES: Dict[str, Dict[str, Any]] = {
    "sepolia": {
        ...
        "ws_env": "AFRITECH_CHAIN_WS_URL_SEPOLIA",
    ...
    "mainnet": {
        ...
        "ws_env": "AFRITECH_CHAIN_WS_URL_MAINNET",
    ...
    "base-sepolia": {
        ...
        "chain_id": 84532,
        "rpc_env": "AFRITECH_CHAIN_RPC_URL_BASE_SEPOLIA",
        "ws_env": "AFRITECH_CHAIN_WS_URL_BASE_SEPOLIA",
